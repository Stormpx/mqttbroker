...
public class ClusterCodecTest {
    ...
    public void rpcMessageTest(){
        ClusterMessage clusterMessage = new ClusterMessage(MessageType.VOTEREQUEST, "123", "1242",  Buffer.buffer("test"));
        Buffer encode = clusterMessage.encode();
    ...
    public void proMessageTest(){
        ...
        RpcMessage proMessage = new RpcMessage("addLog", 12,JsonObject.mapFrom(actionLog));
        Buffer encode = proMessage.encode();
        RpcMessage message = RpcMessage.decode(encode);
    ...
    public void logEntryTest(){
        ...
        LogEntry logEntry = new LogEntry().setTerm(1).setIndex(1).setNodeId("node1").setProposalId(1).setPayload(json.toBuffer());
        ...
        Assertions.assertEquals(entry.getProposalId(),logEntry.getProposalId());
    ...
    public void appendEntriesMessageTest(){
        JsonObject json = JsonObject.mapFrom(ActionLog.saveMessage("123", "wqe", false, "213", 0));
        LogEntry logEntry1 = new LogEntry().setTerm(1).setIndex(1).setNodeId("node1").setProposalId(1).setPayload(json.toBuffer());
        LogEntry logEntry2 = new LogEntry().setTerm(2).setIndex(2).setNodeId("node2").setProposalId(2).setPayload(json.toBuffer());
